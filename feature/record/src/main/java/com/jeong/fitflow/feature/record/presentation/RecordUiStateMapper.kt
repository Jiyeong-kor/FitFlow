...
import com.jeong.fitflow.feature.record.contract.RecordCaloriesContract
...
class RecordUiStateMapper @Inject constructor(
    ...
    private fun trackerStatusFallback(logs: List<ActivityLogEntry>) =
        logs.lastOrNull()?.status ?: com.jeong.fitflow.feature.record.api.model.ActivityRecognitionStatus.Unknown
}
