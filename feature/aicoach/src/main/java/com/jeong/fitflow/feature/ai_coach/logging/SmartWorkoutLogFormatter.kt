...
class SmartWorkoutLogFormatter {
    ...
    fun formatWarningEvent(event: PostureWarningEvent): String = buildString {
    ...
    fun formatAttemptStart(metrics: SquatFrameMetrics, timestampMs: Long): String = buildString {
    ...
    fun formatAttemptEnd(metrics: SquatFrameMetrics, timestampMs: Long): String = buildString {
    ...
    fun formatDepthReached(metrics: SquatFrameMetrics, timestampMs: Long): String = buildString {
