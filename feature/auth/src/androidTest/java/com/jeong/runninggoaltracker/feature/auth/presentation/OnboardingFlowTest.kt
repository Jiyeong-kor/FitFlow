...
class OnboardingFlowTest {
    ...
    @Test
    fun authChoiceKakaoNavigatesToNickname() {
        val uiState = mutableStateOf(OnboardingUiState(step = OnboardingStep.AuthChoice))
        ...
        composeRule.onNodeWithTag(ONBOARDING_AUTH_CHOICE_KAKAO_TAG).performClick()
        composeRule.onNodeWithTag(ONBOARDING_NICKNAME_INPUT_TAG).assertExists()
    }
}
